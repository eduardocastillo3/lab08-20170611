      ...
      <center class="cent1" >Editar Usuario</center>
		...
		<br><br>			
        	...
        	<tbody>				
				...
				<input type="text" name="name" class="form-control" required autofocus value="<%=user.getName() %>"></td>				
				...
				<input type="text" name="email" class="form-control" required value="<%= user.getEmail() %>"></td>			
				<td><label>Fecha de nacimiento</label>
				<input type="date" name="birth" class="form-control" required value="<%= birth.format(user.getBirth()) %>"></td>
				</tr>
				<td><label>DNI</label>
				<input type="text" name="DNI" class="form-control" required value="<%= user.getDNI() %>" required pattern="[0-9]{8}"></td>
				<td><label>Telefono</label>
				<input type="text" name="phone" class="form-control" required value="<%= user.getPhone() %>" required pattern="[0-9]{9}"></td>
				</tr>
				<tr>
				<td><label>Direccion</label>
				<input type="text" name="address" class="form-control" required value="<%= user.getAddress() %>"></td>
				<td><label>role</label>
				...
				<p><%= created.format(user.getCreated()) %></p></td>
				        ...
				        <button type="submit" class="btn btn-info btn-responsive">Registrar</button>
        </div><br><br>
    </form>
    </div>
